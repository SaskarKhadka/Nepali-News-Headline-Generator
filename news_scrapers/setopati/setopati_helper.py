...
for key, value in SETOPATI_WEBSITES.items():
    for index, news_cover_link in enumerate(news_links):
        ...
        try:
            ...
            publish_date = driver.find_element(By.CSS_SELECTOR, 'div.published-date span.pub-date').text
            news_paragraphs = driver.find_elements(By.CSS_SELECTOR, 'div.row div.detail-box div.editor-box p')
            news = []
            ...
            df.to_csv('setopati_news_final2.csv', index=None)
