...
with codecs.open('nepalikhabar_news_links.csv', 'r', 'utf-8') as file:
    news_links = file.readlines()
    
with codecs.open('nepalikhabar_news_titles.csv', 'r', 'utf-8') as file:
...
for key, value in NEPALIKHABAR_WEBSITES.items():
    for index, news_cover_link in enumerate(news_links):
        ...
        try:
            ...
            publish_date = driver.find_element(By.XPATH, '/html/body/div[7]/div[2]/div/div/div/div[2]/div[1]/article/div/div/div[2]/div[2]').text
            news_paragraphs = driver.find_elements(By.CSS_SELECTOR, 'div#body-content span p')
            news = []
            ...
            df.to_csv('nepalikhabar_news_final2.csv', index=None)
